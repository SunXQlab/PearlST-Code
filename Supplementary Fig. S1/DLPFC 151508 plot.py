...
axs[0,1].set_title('SEDR  ARI:0.384', fontsize=10)
...
axs[0,2].set_title('BayesSpace  ARI:0.437', fontsize=10)
...
axs[0,4].set_title('DeepST  ARI:0.360', fontsize=10)
...
axs[0,5].set_title('SpaGCN  ARI:0.367', fontsize=10)
...
axs[1,0].set_title('PearlST  ARI:0.545', fontsize=10)
...
axs[1,1].set_title('Seurat  ARI:0.379', fontsize=10)
...
axs[1,2].set_title('STAGATE  ARI:0.213', fontsize=10)
...
axs[1,3].set_title('Scanpy  ARI:0.246', fontsize=10)
...
axs[1,4].set_title('SpecMix  ARI:0.417', fontsize=10)
...
axs[1,5].set_title('stLearn  ARI:0.315', fontsize=10)


plt.savefig('151508_benchmarking.pdf', dpi=300)
