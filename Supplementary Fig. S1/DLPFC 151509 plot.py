...
axs[0,1].set_title('SEDR  ARI:0.383', fontsize=10)
...
axs[0,2].set_title('BayesSpace  ARI:0.394', fontsize=10)
...
axs[0,3].set_title('SpaceFlow  ARI:0.394', fontsize=10)
...
axs[0,4].set_title('DeepST  ARI:0.364', fontsize=10)
...
axs[0,5].set_title('SpaGCN  ARI:0.377', fontsize=10)
...
axs[1,0].set_title('PearlST  ARI:0.564', fontsize=10)
...
axs[1,1].set_title('Seurat  ARI:0.223', fontsize=10)
...
axs[1,2].set_title('STAGATE  ARI:0.243', fontsize=10)
...
axs[1,3].set_title('Scanpy  ARI:0.280', fontsize=10)
...
axs[1,4].set_title('SpecMix  ARI:0.407', fontsize=10)
...
axs[1,5].set_title('stLearn  ARI:0.414', fontsize=10)


plt.savefig('151509_benchmarking.pdf', dpi=300)
