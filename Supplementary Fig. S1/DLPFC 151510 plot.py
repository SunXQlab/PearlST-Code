...
axs[0,1].set_title('SEDR  ARI:0.302', fontsize=10)
...
axs[0,2].set_title('BayesSpace  ARI:0.434', fontsize=10)
...
axs[0,3].set_title('SpaceFlow  ARI:0.349', fontsize=10)
...
axs[0,4].set_title('DeepST  ARI:0.520', fontsize=10)
...
axs[0,5].set_title('SpaGCN  ARI:0.443', fontsize=10)
...
axs[1,0].set_title('PearlST  ARI:0.529', fontsize=10)
...
axs[1,1].set_title('Seurat  ARI:0.332', fontsize=10)
...
axs[1,2].set_title('STAGATE  ARI:0.244', fontsize=10)
...
axs[1,3].set_title('Scanpy  ARI:0.229', fontsize=10)
...
axs[1,4].set_title('SpecMix  ARI:0.316', fontsize=10)
...
axs[1,5].set_title('stLearn  ARI:0.444', fontsize=10)


plt.savefig('151510_benchmarking.pdf', dpi=300)
