...
plot_true_label_color = ['#A1A9D0', '#F0988C', '#B883D4', '#CFEAF1', '#C4A5DE', '#F6CAE5']
adata.uns['Manual annotation_colors'] = plot_true_label_color
plot_color = ['#A1A9D0', '#F0988C', '#B883D4', '#CFEAF1', '#C4A5DE']
...
adata.uns['specmix_colors'] = ['#A1A9D0', '#F0988C', '#B883D4', '#CFEAF1', '#C4A5DE', '#F6CAE5']
...
axs[0,1].set_title('SEDR  ARI:0.364', fontsize=10)
...
axs[0,2].set_title('BayesSpace  ARI:0.471', fontsize=10)
...
axs[0,3].set_title('SpaceFlow  ARI:0.314', fontsize=10)
...
axs[0,4].set_title('DeepST  ARI:0.388', fontsize=10)
...
axs[0,5].set_title('SpaGCN  ARI:0.224', fontsize=10)
...
axs[1,0].set_title('PearlST  ARI:0.740', fontsize=10)
...
axs[1,1].set_title('Seurat  ARI:0.323', fontsize=10)
...
axs[1,2].set_title('STAGATE  ARI:0.272', fontsize=10)
...
axs[1,3].set_title('Scanpy  ARI:0.138', fontsize=10)
...
axs[1,4].set_title('SpecMix  ARI:0.144', fontsize=10)
...
axs[1,5].set_title('stLearn  ARI:0.326', fontsize=10)


plt.savefig('151669_benchmarking.pdf', dpi=300)
