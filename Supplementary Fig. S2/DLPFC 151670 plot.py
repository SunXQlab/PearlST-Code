...
axs[0,1].set_title('SEDR  ARI:0.423', fontsize=10)
...
axs[0,2].set_title('BayesSpace  ARI:0.430', fontsize=10)
...
axs[0,3].set_title('SpaceFlow  ARI:0.158', fontsize=10)
...
axs[0,4].set_title('DeepST  ARI:0.328', fontsize=10)
...
axs[0,5].set_title('SpaGCN  ARI:0.372', fontsize=10)
...
axs[1,0].set_title('PearlST  ARI:0.781', fontsize=10)
...
axs[1,1].set_title('Seurat  ARI:0.317', fontsize=10)
...
axs[1,2].set_title('STAGATE  ARI:0.246', fontsize=10)
...
axs[1,3].set_title('Scanpy  ARI:0.145', fontsize=10)
...
axs[1,4].set_title('SpecMix  ARI:0.121', fontsize=10)
...
axs[1,5].set_title('stLearn  ARI:0.228', fontsize=10)


plt.savefig('151670_benchmarking.pdf', dpi=300)
