...
axs[0,1].set_title('SEDR  ARI:0.492', fontsize=10)
...
axs[0,2].set_title('BayesSpace  ARI:0.439', fontsize=10)
...
axs[0,3].set_title('SpaceFlow  ARI:0.415', fontsize=10)
...
axs[0,4].set_title('DeepST  ARI:0.552', fontsize=10)
...
axs[0,5].set_title('SpaGCN  ARI:0.561', fontsize=10)
...
axs[1,1].set_title('Seurat  ARI:0.191', fontsize=10)
...
axs[1,2].set_title('STAGATE  ARI:0.347', fontsize=10)
...
axs[1,3].set_title('Scanpy  ARI:0.143', fontsize=10)
...
axs[1,4].set_title('SpecMix  ARI:0.566', fontsize=10)
...
axs[1,5].set_title('stLearn  ARI:0.347', fontsize=10)


plt.savefig('151672_benchmarking.pdf', dpi=300)
