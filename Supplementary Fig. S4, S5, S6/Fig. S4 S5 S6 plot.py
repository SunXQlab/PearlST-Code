...
from utils import plot_pSM_multi_4, plot_pSM, prepare_figure_multi_4, pseudo_Spatiotemporal_Map
...
sc.tl.paga(umap_warga, groups='warga')

sc.tl.paga(umap_spaceflow, groups='spaceflow')

sc.tl.paga(umap_sedr, groups='sedr')

sc.tl.paga(umap_stlearn, groups='stlearn')

sc.tl.paga(umap_deepst, groups='deepst')

sc.tl.paga(umap_seurat, groups='seurat')

sc.tl.paga(umap_stagate, groups='stagate')

sc.tl.paga(umap_specmix, groups='specmix')

sc.tl.paga(umap_scanpy, groups='scanpy')
...
fig, axs = plt.subplots(1, 4, figsize=(13,3),constrained_layout=True)
sc.pl.umap(umap_deepst, color=['deepst'],  ax=axs[0],
           show=False,  size=30, legend_loc='on data', legend_fontsize=0)
axs[0].spines['right'].set_visible(False) # 去掉边框
axs[0].spines['top'].set_visible(False)   # 去掉边框
axs[0].spines['left'].set_visible(False) # 去掉边框
...
axs[0].get_yaxis().set_visible(False)
axs[0].get_xaxis().set_visible(False)
axs[0].set_title('DeepST', fontsize=12)

sc.pl.umap(umap_scanpy, color='scanpy', ax=axs[1], show=False, size=30, legend_loc='on data', legend_fontsize=0)
axs[1].spines['right'].set_visible(False) # 去掉边框
axs[1].spines['top'].set_visible(False)   # 去掉边框
axs[1].spines['left'].set_visible(False) # 去掉边框
axs[1].spines['bottom'].set_visible(False)   # 去掉边框
axs[1].get_yaxis().set_visible(False)
axs[1].get_xaxis().set_visible(False)
axs[1].set_title('Scanpy', fontsize=12)

sc.pl.umap(umap_seurat, color='seurat', ax=axs[2], show=False, size=30, legend_loc='on data', legend_fontsize=0)
axs[2].spines['right'].set_visible(False) # 去掉边框
axs[2].spines['top'].set_visible(False)   # 去掉边框
axs[2].spines['left'].set_visible(False) # 去掉边框
axs[2].spines['bottom'].set_visible(False)   # 去掉边框
axs[2].get_yaxis().set_visible(False)
axs[2].get_xaxis().set_visible(False)
axs[2].set_title('Seurat', fontsize=12)

sc.pl.umap(umap_specmix, color='specmix', ax=axs[3], show=False, size=30, legend_loc='on data', legend_fontsize=0)
axs[3].spines['right'].set_visible(False) # 去掉边框
axs[3].spines['top'].set_visible(False)   # 去掉边框
axs[3].spines['left'].set_visible(False) # 去掉边框
axs[3].spines['bottom'].set_visible(False)   # 去掉边框
axs[3].get_yaxis().set_visible(False)
axs[3].get_xaxis().set_visible(False)
axs[3].set_title('SpecMix', fontsize=12)


plt.savefig('C:/Users/haiyu/Desktop/151671_embedding_supplementary.pdf', dpi=300)



fig, axs = plt.subplots(2, 4, figsize=(13,6),constrained_layout=True)
sc.pl.paga(umap_stagate, color=['stagate'],  ax=axs[0,0], show=False, fontsize=8)
...
axs[0,0].set_title('STAGATE', fontsize=12)

sc.pl.paga(umap_spaceflow, color='spaceflow', ax=axs[0,1], show=False, fontsize=8)
...
axs[0,1].set_title('SpaceFlow', fontsize=12)

sc.pl.paga(umap_sedr, color='sedr', ax=axs[0,2], show=False, fontsize=8)
...
axs[0,2].set_title('SEDR', fontsize=12)

sc.pl.paga(umap_specmix, color='specmix', ax=axs[0,3], show=False, fontsize=8)
...
axs[0,3].set_title('SpecMix', fontsize=12)

sc.pl.paga(umap_deepst, color='deepst',  ax=axs[1,0], show=False, fontsize=8)
...
axs[1,0].set_title('DeepST', fontsize=12)

sc.pl.paga(umap_scanpy, color='scanpy', ax=axs[1,1], show=False, fontsize=8)
...
axs[1,1].set_title('Scanpy', fontsize=12)

sc.pl.paga(umap_seurat, color='seurat', ax=axs[1,2], show=False, fontsize=8)
...
axs[1,2].set_title('Seurat', fontsize=12)

sc.pl.paga(umap_warga, color='warga', ax=axs[1,3], show=False, fontsize=8)
...
axs[1,3].set_title('PearlST', fontsize=12)
plt.savefig('C:/Users/haiyu/Desktop/151671_paga_all.pdf', dpi=300)
...
plot_pSM_multi_4(adata=adata_specmix, adata1=adata_deepst, adata2=adata_seurat, adata3=scanpy, scatter_sz=30., rsz=3.,
