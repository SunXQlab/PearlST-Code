...
axs[0,2].set_title('BayesSpace  ARI:0.529', fontsize=10)
...
axs[0,3].set_title('SpaceFlow  ARI:0.380', fontsize=10)
...
axs[0,4].set_title('DeepST  ARI:0.516', fontsize=10)
...
axs[0,5].set_title('SpaGCN  ARI:0.300', fontsize=10)
...
axs[1,0].set_title('PearlST  ARI:0.549', fontsize=10)
...
axs[1,1].set_title('Seurat  ARI:0.292', fontsize=10)
...
axs[1,2].set_title('STAGATE  ARI:0.387', fontsize=10)
...
axs[1,3].set_title('Scanpy  ARI:0.288', fontsize=10)
...
axs[1,4].set_title('SpecMix  ARI:0.340', fontsize=10)
...
axs[1,5].set_title('stLearn  ARI:0.384', fontsize=10)


plt.savefig('151675_benchmarking.pdf', dpi=300)
