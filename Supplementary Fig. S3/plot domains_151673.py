...
axs[0,1].set_title('SEDR  ARI:0.562', fontsize=10)
...
axs[0,2].set_title('BayesSpace  ARI:0.549', fontsize=10)
...
axs[0,3].set_title('SpaceFlow  ARI:0.438', fontsize=10)
...
axs[0,4].set_title('DeepST  ARI:0.456', fontsize=10)
...
axs[0,5].set_title('SpaGCN  ARI:0.461', fontsize=10)
...
axs[1,0].set_title('stLearn  ARI:0.623', fontsize=10)
...
axs[1,1].set_title('Seurat  ARI:0.388', fontsize=10)
...
axs[1,2].set_title('STAGATE  ARI:0.361', fontsize=10)
...
axs[1,3].set_title('Scanpy  ARI:0.169', fontsize=10)
...
axs[1,4].set_title('SpecMix  ARI:0.568', fontsize=10)
...
axs[1,5].set_title('stLearn  ARI:0.305', fontsize=10)


plt.savefig('151673_benchmarking.pdf', dpi=300)
