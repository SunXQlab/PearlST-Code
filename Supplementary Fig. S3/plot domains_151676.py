...
axs[0,1].set_title('SEDR  ARI:0.455', fontsize=10)
...
axs[0,2].set_title('BayesSpace  ARI:0.367', fontsize=10)
...
axs[0,4].set_title('DeepST  ARI:0.446', fontsize=10)
...
axs[0,5].set_title('SpaGCN  ARI:0.326', fontsize=10)
...
axs[1,0].set_title('PearlST  ARI:0.517', fontsize=10)
...
axs[1,1].set_title('Seurat  ARI:0.311', fontsize=10)
...
axs[1,2].set_title('STAGATE  ARI:0.315', fontsize=10)
...
axs[1,3].set_title('Scanpy  ARI:0.218', fontsize=10)
...
axs[1,4].set_title('SpecMix  ARI:0.435', fontsize=10)
...
axs[1,5].set_title('stLearn  ARI:0.400', fontsize=10)


plt.savefig('151676_benchmarking.pdf', dpi=300)
