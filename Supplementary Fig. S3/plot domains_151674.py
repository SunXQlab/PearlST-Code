...
axs[0,1].set_title('SEDR  ARI:0.431', fontsize=10)
...
axs[0,2].set_title('BayesSpace  ARI:0.296', fontsize=10)
...
axs[0,3].set_title('SpaceFlow  ARI:0.316', fontsize=10)
...
axs[0,4].set_title('DeepST  ARI:0.396', fontsize=10)
...
axs[0,5].set_title('SpaGCN  ARI:0.323', fontsize=10)
...
axs[1,0].set_title('PearlST  ARI:0.569', fontsize=10)
...
axs[1,1].set_title('Seurat  ARI:0.304', fontsize=10)
...
axs[1,2].set_title('STAGATE  ARI:0.383', fontsize=10)
...
axs[1,3].set_title('Scanpy  ARI:0.319', fontsize=10)
...
axs[1,4].set_title('SpecMix  ARI:0.402', fontsize=10)
...
axs[1,5].set_title('stLearn  ARI:0.386', fontsize=10)


plt.savefig('151674_benchmarking.pdf', dpi=300)
